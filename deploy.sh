...
npx hardhat deploy_bond --name DAI --network remote --silent
npx hardhat deploy_lpbond --name GIZADAI  --network remote --silent
npx hardhat deploy_hyper_lpbond --name GIZAMIM_HYPER --network remote --silent
# npx hardhat deploy_hyper_aggbond --name FTM_HYPER --network remote --silent
